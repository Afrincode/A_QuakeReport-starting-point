...
*/
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String jsonresponse) {
        ...
        try {
            ...
            featuresArr=root.getJSONArray("features");//getJSONArray("Feature");
            System.out.println("the feature array: "+featuresArr);
            System.out.println("========================================the length of the features array==="+featuresArr.length());
            for(int i=0;i<featuresArr.length();i++)
            {
                System.out.println("=========================================i==="+i);
               JSONObject nextEarthquake=featuresArr.getJSONObject(i);
               JSONObject earthquakePropObj=nextEarthquake.getJSONObject("properties");

               String magnitude=earthquakePropObj.optString("mag");
               String place=earthquakePropObj.optString("place");
              // String time=earthquakePropObj.optString("time");
                long time =earthquakePropObj.getLong("time");
                Earthquake obj=new Earthquake(magnitude,place,time);
               earthquakes.add(obj);
            }
